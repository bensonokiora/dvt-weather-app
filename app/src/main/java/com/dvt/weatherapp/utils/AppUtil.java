...
public class AppUtil {
    ...
    public static void setWeatherIcon(Context context, AppCompatImageView imageView, int weatherCode) {
        if (weatherCode / 100 == 2) {
            Glide.with(context).load(R.drawable.rain).into(imageView);
        } else if (weatherCode / 100 == 3) {
            Glide.with(context).load(R.drawable.rain2x).into(imageView);
        } else if (weatherCode / 100 == 5) {
            Glide.with(context).load(R.drawable.rain3x).into(imageView);
            ...
            Glide.with(context).load(R.drawable.clear3x).into(imageView);
        } else if (weatherCode == 801) {
            Glide.with(context).load(R.drawable.clear2x).into(imageView);
        } else if (weatherCode == 803) {
            Glide.with(context).load(R.drawable.clear).into(imageView);
        } else if (weatherCode / 100 == 8) {
            Glide.with(context).load(R.drawable.partlysunny).into(imageView);
        }
    }
    ...
    public static int getWeatherBackgroundImage(int weatherCode) {
        if (weatherCode / 100 == 2 || weatherCode / 100 == 3 || weatherCode / 100 == 5 || weatherCode / 100 == 6) {
